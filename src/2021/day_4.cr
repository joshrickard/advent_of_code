...
Utils::Runner.run(input_path, Year2021::Day4::Part1) if ARGV.size.positive? && ARGV.first == "part1"
Utils::Runner.run(input_path, Year2021::Day4::Part2) if ARGV.size.positive? && ARGV.first == "part2"
